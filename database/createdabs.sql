...
alter table t_employee_role add constraint FK_employee_role foreign key (emp_id)
      references t_employee (emp_id) on delete restrict on update restrict;

alter table t_employee_role add constraint FK_employee_role2 foreign key (role_id)
...
alter table t_role_privilege add constraint FK_own foreign key (pri_id)
