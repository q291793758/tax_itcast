        ...
        <div class="p_d_1_1">
            <div class="content_info">
                ...
                <div class="search_art">
                    <li>
                        投诉标题：<s:textfield name="searchString" id="searchString" cssClass="s_text"
                    ...
                    <li>
                        状态：<s:select name="strState" id="strState" list="#complainStateMap" headerKey=""
                                     headerValue="全部"/>
                    </li>
                        ...
                        <s:iterator value="pageResult.items" status="st">
                            <tr <s:if test="#st.odd"> bgcolor="f8f8f8" </s:if> >
                                ...
                                <td align="center">
                                    ...
                                    <s:else>
                                        <a href="javascript:doDeal('<s:property value='compId'/>')">查看</a>
                                    </s:else>
