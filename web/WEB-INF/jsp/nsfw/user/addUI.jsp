...
<form id="form" name="form" action="${pageContext.request.contextPath}/nsfw/user_add.action" method="post"
            ...
            <div class="content_info">
                ...
                <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0"
                    ...
                    <tr>
                        ...
                        <td><s:textfield id="account" name="user.account" onchange="doVerify()"/><p style="color: red" id="pID"></p></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><s:radio list="#{'true':'男','false':'女'}" name="user.gender" value="1"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <s:textfield id="birthday" name="user.birthday" readonly="true"
                                         onfocus="WdatePicker({'skin':'whyGreen','dateFmt':'yyyy-MM-dd'});"><s:param
                                    name="value"><s:date name="user.birthday" format="yyyy-MM-dd"/></s:param>
                            </s:textfield>
                        </td>
                    </tr>
                    <tr>
