...
<head>
    ...
    <script type="text/javascript">
        ...
        //编辑
        function doEdit(id){
            document.forms[0].action = "${pageContext.request.contextPath}/nsfw/user_editUI.action?user.id=" + id;
            document.forms[0].submit();
        }
        //删除
        function doDelete(id){
            document.forms[0].action = "${pageContext.request.contextPath}/nsfw/user_delete.action?user.id=" + id;
            document.forms[0].submit();
        }
        //批量删除
        function doDeleteAll(id){
            document.forms[0].action = "${pageContext.request.contextPath}/nsfw/user_deleteSelected.action?id="+id;
            document.forms[0].submit();
        }
        //导出用户列表
