        ...
        try {
            ...
            if (userList != null) {
                for (int j = 0; j < userList.size(); j++) {
                    ...
                    cell15.setCellValue(userList.get(j).getMobile()+"");
                    //电子邮箱
                    HSSFCell cell16 = row.createCell(5);
                    cell16.setCellValue(userList.get(j).getEmail());
                    //生日
                    HSSFCell cell17 = row.createCell(6);
                    Date birthday = userList.get(j).getBirthday();
                    try {
                        SimpleDateFormat df = new SimpleDateFormat("yyyy/MM/dd");
                        cell17.setCellValue(df.format(birthday));
                    } catch (Exception e) {
                        cell17.setCellValue(" ");
                    }
                }
